...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = "postgresql+asyncpg://postgres.eszefwyralssfhktrwno:Sankar%401986%2304@aws-0-ap-southeast-1.pooler.supabase.com:6543/postgres?prepared_statement_cache_size=0"
