...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-neutral-950 px-4 py-12 text-center selection:bg-amber-500 selection:text-neutral-950">
      ...
      <div className="max-w-2xl w-full bg-neutral-900/90 border border-neutral-800/90 rounded-3xl p-8 shadow-2xl backdrop-blur-xl relative z-10 space-y-7">
        ...
        {/* Guest In-Room App CTA */}
        <div className="p-4 bg-gradient-to-b from-amber-500/10 to-transparent border border-amber-500/30 rounded-2xl text-left space-y-2.5">
