...
url = "https://www.hotelbluebirdnest.com/api/v1/reception/check-in"
payload = json.dumps({
    "room_number": "204",
...
print("=== VERIFYING LIVE RECEPTION CHECK-IN API ENDPOINT ===")
try:
    ...
    with urllib.request.urlopen(req, context=ctx, timeout=10) as resp:
        ...
        print(f"[HTTP {resp.status}] SUCCESS: Guest Checked In!")
